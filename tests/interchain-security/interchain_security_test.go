...
import (
	...
	appConsumer "github.com/blockhunters-org/hunterverse/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and hunterverse consumer chain
